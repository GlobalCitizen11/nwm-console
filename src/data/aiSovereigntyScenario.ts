...
const seededContinuation: ScenarioDataset["events"] = [
  {
    ...
    month: 5,
    label: "A4A",
    title: "Strategic Infrastructure Compute Audit Trail Proposal",
    description:
      "A draft audit-trail standard proposes mandatory traceability for high-scale compute usage across sovereign and private operators.",
    sourceType: "policy",
    domainTags: ["audit", "compute", "traceability"],
    structuralEffect: "reclassify",
    metrics: { velocity: 46, density: 53, coherence: 46, reversibility: 45 },
  ...
  },
  {
    ...
    month: 9,
    label: "A7A",
    title: "National Model Hosting Registry Proposal",
    description:
      "A hosting registry proposal increases expectations that advanced model deployment will be tied to named jurisdictional infrastructure.",
    sourceType: "legal",
    domainTags: ["hosting", "registry", "models"],
    structuralEffect: "reclassify",
    metrics: { velocity: 53, density: 64, coherence: 51, reversibility: 32 },
    phase: "Escalation Edge",
    haloColor: "#c76c2d",
  },
  {
  ...
  },
  {
    ...
    month: 13,
    label: "A10A",
    title: "Strategic GPU Access Disclosure in Financing Covenants",
    description:
      "Major financing agreements begin requiring disclosure of strategic GPU access dependencies and concentrated compute exposure.",
    sourceType: "market",
    domainTags: ["finance", "gpu", "exposure"],
    structuralEffect: "reclassify",
    metrics: { velocity: 56, density: 69, coherence: 58, reversibility: 23 },
    phase: "Structural Reclassification",
    haloColor: "#a94646",
  },
  {
  ...
  },
  {
    ...
    month: 17,
    label: "A13A",
    title: "Trusted Inference Corridor Certification",
    description:
      "A trusted inference corridor certification formalizes which jurisdictions and providers can serve regulated high-capability workloads.",
    sourceType: "sovereign",
    domainTags: ["inference", "trusted", "certification"],
    structuralEffect: "reclassify",
    metrics: { velocity: 55, density: 80, coherence: 64, reversibility: 14 },
    phase: "Fragmented Regime",
    haloColor: "#645091",
  },
  {
  ...
  },
  {
    ...
    month: 18,
    label: "A15",
    title: "Cross-Border Model Service Partition Standard",
    description:
      "A partition standard codifies cross-border model service lanes and confirms a durable split between trusted and restricted compute environments.",
    sourceType: "legal",
    domainTags: ["cross-border", "services", "partition"],
    structuralEffect: "reclassify",
    metrics: { velocity: 53, density: 82, coherence: 67, reversibility: 12 },
    phase: "Fragmented Regime",
    haloColor: "#645091",
  },
];
