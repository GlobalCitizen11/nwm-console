...
export interface ExecutiveBriefSpec {
  header: {
    ...
    briefMode: FieldRule<string>;
    validityLabel: FieldRule<string>;
...
export interface ExecutiveBriefSourceIntelligence {
  ...
  stateParagraph: string;
  systemStateSidebar?: string;
  narrativeTitle: string;
  longitudinalSignalsParagraph: string;
  motifPersistenceParagraph: string;
  stateVectorParagraph: string;
  narrativeSidebar?: string;
  structuralTitle: string;
  phaseAdjudicationParagraph: string;
  momentumParagraph: string;
  structuralSidebar?: string;
  haloTitle: string;
  haloIntegrityParagraph: string;
  categorySeparationParagraph: string;
  haloSidebar?: string;
  traceabilityTitle: string;
  traceabilityParagraph: string;
  auditParagraph?: string;
  validityConditions: string[];
  failureModes: string[];
  traceabilityMarkers: string[];
  traceabilitySidebar?: string;
