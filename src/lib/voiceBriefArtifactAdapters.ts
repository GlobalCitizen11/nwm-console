...
import { SYSTEM_DISPLAY_LABELS, SYSTEM_LABELS } from "./systemLabels";
...
export function mapVoiceBriefToExecutiveBriefSpec(
  ...
  return buildExecutiveBriefSpec({
    ...
    briefMode: SYSTEM_DISPLAY_LABELS.framework,
    validityLabel: "Structurally Valid",
    ...
    boundaryParagraph: intelligence.systemState.summary,
    stateParagraph: intelligence.systemState.sidebarInsight,
    systemStateSidebar: intelligence.systemState.sidebarInsight,
    narrativeTitle: "Structural Memory",
    longitudinalSignalsParagraph: intelligence.narrativeProgression.summary,
    motifPersistenceParagraph: intelligence.structuralRead.summary,
    stateVectorParagraph: intelligence.structuralRead.sidebarInsight,
    narrativeSidebar: intelligence.narrativeProgression.sidebarInsight,
    structuralTitle: SYSTEM_LABELS.PAL,
    phaseAdjudicationParagraph: intelligence.structuralRead.summary,
    momentumParagraph: intelligence.structuralRead.sidebarInsight,
    structuralSidebar: intelligence.structuralRead.sidebarInsight,
    haloTitle: SYSTEM_DISPLAY_LABELS.interpretationLayerIntegrity,
    haloIntegrityParagraph: intelligence.forwardView.summary,
    categorySeparationParagraph: intelligence.forwardView.sidebarInsight,
    haloSidebar: intelligence.forwardView.sidebarInsight,
    traceabilityTitle: "Proof Object Traceability",
    traceabilityParagraph: intelligence.decisionPosture.summary,
    auditParagraph: intelligence.decisionPosture.sidebarInsight,
    validityConditions: intelligence.decisionPosture.actions?.slice(0, 4) ?? [],
    failureModes: intelligence.riskConcentration.slice(0, 4),
    traceabilityMarkers: intelligence.decisionActions.slice(0, 4),
    traceabilitySidebar: intelligence.decisionPosture.sidebarInsight,
    evidenceTitle: intelligence.evidenceBase.title,
    evidenceIntro: intelligence.evidenceBase.intro,
